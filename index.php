...
<head>
    ...
    <title>Halaman Login | Sistem Informasi Buku Tamu Nioke Dev</title>
    <!-- Buat Favicon -->
    <link rel="icon" href="assets/img/logo N.png" type="image/x-icon">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 d-lg-block bg-success shadow-lg p-5 text-center">
                                <img src="assets/img/logo N.png" alt="" width="250">
                                <h3 class="text-white">
                                    Sistem Informasi Buku Tamu
                                    <br><b>Nioke Dev</b>
                                    <br><small>Probolingo, Jawa Timur</small>
                                </h3>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="forgot-password.html">By. Channel Ngodingpintar | 2021 - <?= date('Y'); ?></a>
                                    </div>
